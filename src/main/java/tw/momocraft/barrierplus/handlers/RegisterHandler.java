...
public class RegisterHandler {
    ...
    public static void registerEvents() {
        ...
        CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPlugin(), "Register-Event", "Spawner", "SpawnerSpawn", "continue",
                new Throwable().getStackTrace()[0]);
        CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPlugin(), "Register-Event", "Destroy", "BlockBreak", "continue",
                new Throwable().getStackTrace()[0]);
        BarrierPlus.getInstance().getServer().getPluginManager().registerEvents(new BlockClick(), BarrierPlus.getInstance());
        CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPlugin(), "Register-Event", "See & Destroy", "BlockClick", "continue",
                new Throwable().getStackTrace()[0]);
        BarrierPlus.getInstance().getServer().getPluginManager().registerEvents(new BlockExplode(), BarrierPlus.getInstance());
        CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPlugin(), "Register-Event", "Destroy", "BlockExplode", "continue",
                new Throwable().getStackTrace()[0]);
        BarrierPlus.getInstance().getServer().getPluginManager().registerEvents(new BlockPlace(), BarrierPlus.getInstance());
        CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPlugin(), "Register-Event", "Place", "BlockPlace", "continue",
                new Throwable().getStackTrace()[0]);
        BarrierPlus.getInstance().getServer().getPluginManager().registerEvents(new EntityExplode(), BarrierPlus.getInstance());
        CorePlusAPI.getLangManager().sendFeatureMsg(ConfigHandler.isDebugging(), ConfigHandler.getPlugin(), "Register-Event", "Destroy", "EntityExplode", "continue",
                new Throwable().getStackTrace()[0]);
    }
}
